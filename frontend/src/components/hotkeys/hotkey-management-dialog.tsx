...
import { Keyboard, RefreshCw, Search, AlertTriangle } from "lucide-react";
...
interface HotkeyManagementDialogProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
}

export function HotkeyManagementDialog({
  open,
  onOpenChange,
}: HotkeyManagementDialogProps) {
  const {
    resolvedHotkeys,
    setCustomKeys,
    toggleHotkey,
            ...
            <div className="space-y-2">
              ...
              <div className="flex justify-end mb-4">
                ...
                >
                  ...
                  Reset {SCOPE_LABELS[activeScope]}
                </Button>
              </div>
...
// Re-export a simpler version that uses the context state
export function HotkeyManagementDialogFromContext() {
  const { isManagementDialogOpen, closeManagementDialog } = useHotkeysConfig();

  return (
    <HotkeyManagementDialog
